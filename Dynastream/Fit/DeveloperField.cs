        ...
        : FieldBase
    {
        ...
        public uint AppVersion
        {
            get
            {
                ...
                {
                    return m_definition.DeveloperIdMessage.GetApplicationVersion() ?? 0;
                }
        ...
        public byte[] AppId
        {
            get
            {
                if (m_definition.IsDefined)
                {
                    var msg = m_definition.DeveloperIdMessage;
        ...
        public override string Name
        {
            get
            {
                return m_definition.IsDefined ?
                    m_definition.DescriptionMessage.GetFieldNameAsString(0) : null;
            }
        }
        ...
        public override byte Type
        {
            get
            {
                if (m_definition.IsDefined)
                {
                    return m_definition.DescriptionMessage.GetFitBaseTypeId() ?? Fit.UInt8;
                }
        ...
        public override double Scale
        {
            get
            {
                if (m_definition.IsDefined)
                {
                    return m_definition.DescriptionMessage.GetScale() ?? 1.0;
                }
        ...
        public override double Offset
        {
            get
            {
                if (m_definition.IsDefined)
                {
                    return m_definition.DescriptionMessage.GetOffset() ?? 0.0;
                }
        ...
        public override string Units
        {
            ...
            {
                return m_definition.IsDefined ?
                    m_definition.DescriptionMessage.GetUnitsAsString(0) : null;
            }
        }
        ...
        public byte NativeOverride
        {
            get
            {
                if (m_definition.IsDefined)
                {
                    return m_definition.DescriptionMessage.GetNativeFieldNum() ?? Fit.FieldNumInvalid;
                }
        ...
        public DeveloperField(FieldDescriptionMessage description, DeveloperDataIdMessage developerDataIdMessage)
        {
            m_definition = new DeveloperFieldDefinition(description, developerDataIdMessage, 0);
        }
