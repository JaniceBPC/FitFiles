...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class DiveSettingsMessage : Message
    {
        #region Fields
        ...
        /// <summary>
        /// Field Numbers for <see cref="DiveSettingsMessage"/>
        /// </summary>
        ...
        #region Constructors
        public DiveSettingsMessage() : base(Profile.GetMessage(MessageNum.DiveSettings))
        {
        }

        public DiveSettingsMessage(Message mesg) : base(mesg)
        {
        }
