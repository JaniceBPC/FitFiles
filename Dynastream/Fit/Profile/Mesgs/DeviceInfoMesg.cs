...
namespace Dynastream.Fit
{
    ...
    public class DeviceInfoMessage : Message
    {
        ...
        /// <summary>
        /// Field Numbers for <see cref="DeviceInfoMessage"/>
        /// </summary>
        ...
        #region Constructors
        public DeviceInfoMessage() : base(Profile.GetMessage(MessageNum.DeviceInfo))
        {
        }

        public DeviceInfoMessage(Message mesg) : base(mesg)
        {
        }
