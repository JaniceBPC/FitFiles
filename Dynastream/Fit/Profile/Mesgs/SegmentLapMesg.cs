...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class SegmentLapMessage : Message
    {
        #region Fields
        ...
        /// <summary>
        /// Field Numbers for <see cref="SegmentLapMessage"/>
        /// </summary>
        ...
        #region Constructors
        public SegmentLapMessage() : base(Profile.GetMessage(MessageNum.SegmentLap))
        {
        }

        public SegmentLapMessage(Message mesg) : base(mesg)
        {
        }
