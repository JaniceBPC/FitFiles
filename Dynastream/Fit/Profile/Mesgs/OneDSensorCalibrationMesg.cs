...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class OneDSensorCalibrationMessage : Message
    {
        #region Fields
        ...
        /// <summary>
        /// Field Numbers for <see cref="OneDSensorCalibrationMessage"/>
        /// </summary>
        ...
        #region Constructors
        public OneDSensorCalibrationMessage() : base(Profile.GetMessage(MessageNum.OneDSensorCalibration))
        {
        }

        public OneDSensorCalibrationMessage(Message mesg) : base(mesg)
        {
        }
