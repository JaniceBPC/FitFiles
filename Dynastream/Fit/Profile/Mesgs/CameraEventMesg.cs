...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class CameraEventMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="CameraEventMessage"/>
        /// </summary>
        ...
        #region Constructors
        public CameraEventMessage() : base(Profile.GetMessage(MessageNum.CameraEvent))
        {
        }

        public CameraEventMessage(Message mesg) : base(mesg)
        {
        }
