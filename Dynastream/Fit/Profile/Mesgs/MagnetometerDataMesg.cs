...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class MagnetometerDataMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="MagnetometerDataMessage"/>
        /// </summary>
        ...
        #region Constructors
        public MagnetometerDataMessage() : base(Profile.GetMessage(MessageNum.MagnetometerData))
        {
        }

        public MagnetometerDataMessage(Message mesg) : base(mesg)
        {
        }
