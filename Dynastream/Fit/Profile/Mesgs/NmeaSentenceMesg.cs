...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class NmeaSentenceMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="NmeaSentenceMessage"/>
        /// </summary>
        ...
        #region Constructors
        public NmeaSentenceMessage() : base(Profile.GetMessage(MessageNum.NmeaSentence))
        {
        }

        public NmeaSentenceMessage(Message mesg) : base(mesg)
        {
        }
