...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class SdmProfileMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="SdmProfileMessage"/>
        /// </summary>
        ...
        #region Constructors
        public SdmProfileMessage() : base(Profile.GetMessage(MessageNum.SdmProfile))
        {
        }

        public SdmProfileMessage(Message mesg) : base(mesg)
        {
        }
