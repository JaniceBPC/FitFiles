...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class FileIdMessage : Message
    {
        #region Fields
        ...
        /// <summary>
        /// Field Numbers for <see cref="FileIdMessage"/>
        /// </summary>
        ...
        #region Constructors
        public FileIdMessage() : base(Profile.GetMessage(MessageNum.FileId))
        {
        }

        public FileIdMessage(Message mesg) : base(mesg)
        {
        }
