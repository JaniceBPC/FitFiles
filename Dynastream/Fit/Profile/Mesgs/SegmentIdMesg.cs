...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class SegmentIdMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="SegmentIdMessage"/>
        /// </summary>
        ...
        #region Constructors
        public SegmentIdMessage() : base(Profile.GetMessage(MessageNum.SegmentId))
        {
        }

        public SegmentIdMessage(Message mesg) : base(mesg)
        {
        }
