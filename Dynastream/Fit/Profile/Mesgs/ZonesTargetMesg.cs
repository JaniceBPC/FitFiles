...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class ZonesTargetMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="ZonesTargetMessage"/>
        /// </summary>
        ...
        #region Constructors
        public ZonesTargetMessage() : base(Profile.GetMessage(MessageNum.ZonesTarget))
        {
        }

        public ZonesTargetMessage(Message mesg) : base(mesg)
        {
        }
