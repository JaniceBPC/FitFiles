...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class LapMessage : Message
    {
        #region Fields
        ...
        /// <summary>
        /// Field Numbers for <see cref="LapMessage"/>
        /// </summary>
        ...
        #region Constructors
        public LapMessage() : base(Profile.GetMessage(MessageNum.Lap))
        {
        }

        public LapMessage(Message mesg) : base(mesg)
        {
        }
