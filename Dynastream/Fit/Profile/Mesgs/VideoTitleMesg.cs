...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class VideoTitleMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="VideoTitleMessage"/>
        /// </summary>
        ...
        #region Constructors
        public VideoTitleMessage() : base(Profile.GetMessage(MessageNum.VideoTitle))
        {
        }

        public VideoTitleMessage(Message mesg) : base(mesg)
        {
        }
