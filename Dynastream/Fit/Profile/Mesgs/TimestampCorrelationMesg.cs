...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class TimestampCorrelationMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="TimestampCorrelationMessage"/>
        /// </summary>
        ...
        #region Constructors
        public TimestampCorrelationMessage() : base(Profile.GetMessage(MessageNum.TimestampCorrelation))
        {
        }

        public TimestampCorrelationMessage(Message mesg) : base(mesg)
        {
        }
