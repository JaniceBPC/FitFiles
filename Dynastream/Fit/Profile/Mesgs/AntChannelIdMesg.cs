...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class AntChannelIdMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="AntChannelIdMessage"/>
        /// </summary>
        ...
        #region Constructors
        public AntChannelIdMessage() : base(Profile.GetMessage(MessageNum.AntChannelId))
        {
        }

        public AntChannelIdMessage(Message mesg) : base(mesg)
        {
        }
