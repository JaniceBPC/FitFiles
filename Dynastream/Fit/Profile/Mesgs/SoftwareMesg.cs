...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class SoftwareMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="SoftwareMessage"/>
        /// </summary>
        ...
        #region Constructors
        public SoftwareMessage() : base(Profile.GetMessage(MessageNum.Software))
        {
        }

        public SoftwareMessage(Message mesg) : base(mesg)
        {
        }
