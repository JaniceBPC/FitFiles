...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class ExdDataConceptConfigurationMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="ExdDataConceptConfigurationMessage"/>
        /// </summary>
        ...
        #region Constructors
        public ExdDataConceptConfigurationMessage() : base(Profile.GetMessage(MessageNum.ExdDataConceptConfiguration))
        {
        }

        public ExdDataConceptConfigurationMessage(Message mesg) : base(mesg)
        {
        }
