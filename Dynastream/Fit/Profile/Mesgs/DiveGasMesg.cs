...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class DiveGasMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="DiveGasMessage"/>
        /// </summary>
        ...
        #region Constructors
        public DiveGasMessage() : base(Profile.GetMessage(MessageNum.DiveGas))
        {
        }

        public DiveGasMessage(Message mesg) : base(mesg)
        {
        }
