...
{
    /// <summary>
    /// Implements the MessageCapabilities profile message.
    /// </summary>
    public class MessageCapabilitiesMessage : Message
    {
        #region Fields
        ...
        /// <summary>
        /// Field Numbers for <see cref="MessageCapabilitiesMessage"/>
        /// </summary>
        public sealed class FieldDefNum
        {
            public const byte MessageIndex = 254;
            public const byte File = 0;
            public const byte MessageNum = 1;
        ...
        #region Constructors
        public MessageCapabilitiesMessage() : base(Profile.GetMessage(MessageNum.MessageCapabilities))
        {
        }

        public MessageCapabilitiesMessage(Message mesg) : base(mesg)
        {
        }
        ...
        ///<summary>
        /// Retrieves the MessageNum field</summary>
        /// <returns>Returns nullable ushort representing the MessageNum field</returns>
        public ushort? GetMessageNum()
        {
        ...
        /// <summary>
        /// Set MessageNum field</summary>
        /// <param name="mesgNum_">Nullable field value to be set</param>
        public void SetMessageNum(ushort? mesgNum_)
        {
        ...
        /// <returns>Returns nullable MessageCount enum representing the CountType field</returns>
        public MessageCount? GetCountType()
        {
            object obj = GetFieldValue(2, 0, Fit.SubfieldIndexMainField);
            MessageCount? value = obj == null ? (MessageCount?)null : (MessageCount)obj;
            return value;
        }
        ...
        public void SetCountType(MessageCount? countType_)
        {
