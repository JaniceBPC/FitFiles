...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class DeviceSettingsMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="DeviceSettingsMessage"/>
        /// </summary>
        ...
        #region Constructors
        public DeviceSettingsMessage() : base(Profile.GetMessage(MessageNum.DeviceSettings))
        {
        }

        public DeviceSettingsMessage(Message mesg) : base(mesg)
        {
        }
