...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class SportMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="SportMessage"/>
        /// </summary>
        ...
        #region Constructors
        public SportMessage() : base(Profile.GetMessage(MessageNum.Sport))
        {
        }

        public SportMessage(Message mesg) : base(mesg)
        {
        }
