...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class VideoFrameMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="VideoFrameMessage"/>
        /// </summary>
        ...
        #region Constructors
        public VideoFrameMessage() : base(Profile.GetMessage(MessageNum.VideoFrame))
        {
        }

        public VideoFrameMessage(Message mesg) : base(mesg)
        {
        }
