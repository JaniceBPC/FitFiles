...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class StressLevelMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="StressLevelMessage"/>
        /// </summary>
        ...
        #region Constructors
        public StressLevelMessage() : base(Profile.GetMessage(MessageNum.StressLevel))
        {
        }

        public StressLevelMessage(Message mesg) : base(mesg)
        {
        }
