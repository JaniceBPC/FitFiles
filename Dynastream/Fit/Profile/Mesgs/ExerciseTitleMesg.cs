...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class ExerciseTitleMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="ExerciseTitleMessage"/>
        /// </summary>
        ...
        #region Constructors
        public ExerciseTitleMessage() : base(Profile.GetMessage(MessageNum.ExerciseTitle))
        {
        }

        public ExerciseTitleMessage(Message mesg) : base(mesg)
        {
        }
