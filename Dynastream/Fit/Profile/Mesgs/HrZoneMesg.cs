...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class HrZoneMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="HrZoneMessage"/>
        /// </summary>
        ...
        #region Constructors
        public HrZoneMessage() : base(Profile.GetMessage(MessageNum.HrZone))
        {
        }

        public HrZoneMessage(Message mesg) : base(mesg)
        {
        }
