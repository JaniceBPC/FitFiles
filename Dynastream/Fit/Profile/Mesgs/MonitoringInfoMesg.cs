...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class MonitoringInfoMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="MonitoringInfoMessage"/>
        /// </summary>
        ...
        #region Constructors
        public MonitoringInfoMessage() : base(Profile.GetMessage(MessageNum.MonitoringInfo))
        {
        }

        public MonitoringInfoMessage(Message mesg) : base(mesg)
        {
        }
