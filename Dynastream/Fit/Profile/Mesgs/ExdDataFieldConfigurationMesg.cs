...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class ExdDataFieldConfigurationMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="ExdDataFieldConfigurationMessage"/>
        /// </summary>
        ...
        #region Constructors
        public ExdDataFieldConfigurationMessage() : base(Profile.GetMessage(MessageNum.ExdDataFieldConfiguration))
        {
        }

        public ExdDataFieldConfigurationMessage(Message mesg) : base(mesg)
        {
        }
