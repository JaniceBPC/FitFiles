...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class HrvMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="HrvMessage"/>
        /// </summary>
        ...
        #region Constructors
        public HrvMessage() : base(Profile.GetMessage(MessageNum.Hrv))
        {
        }

        public HrvMessage(Message mesg) : base(mesg)
        {
        }
