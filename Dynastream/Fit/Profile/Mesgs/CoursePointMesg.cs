...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class CoursePointMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="CoursePointMessage"/>
        /// </summary>
        ...
        #region Constructors
        public CoursePointMessage() : base(Profile.GetMessage(MessageNum.CoursePoint))
        {
        }

        public CoursePointMessage(Message mesg) : base(mesg)
        {
        }
