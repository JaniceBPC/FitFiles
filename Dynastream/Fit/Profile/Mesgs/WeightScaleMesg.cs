...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class WeightScaleMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="WeightScaleMessage"/>
        /// </summary>
        ...
        #region Constructors
        public WeightScaleMessage() : base(Profile.GetMessage(MessageNum.WeightScale))
        {
        }

        public WeightScaleMessage(Message mesg) : base(mesg)
        {
        }
