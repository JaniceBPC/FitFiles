...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class MonitoringMessage : Message
    {
        #region Fields
        ...
        /// <summary>
        /// Field Numbers for <see cref="MonitoringMessage"/>
        /// </summary>
        ...
        #region Constructors
        public MonitoringMessage() : base(Profile.GetMessage(MessageNum.Monitoring))
        {
        }

        public MonitoringMessage(Message mesg) : base(mesg)
        {
        }
