...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class DeveloperDataIdMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="DeveloperDataIdMessage"/>
        /// </summary>
        ...
        #region Constructors
        public DeveloperDataIdMessage() : base(Profile.GetMessage(MessageNum.DeveloperDataId))
        {
        }

        public DeveloperDataIdMessage(Message mesg) : base(mesg)
        {
        }
