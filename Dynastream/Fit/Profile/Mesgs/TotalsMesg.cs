...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class TotalsMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="TotalsMessage"/>
        /// </summary>
        ...
        #region Constructors
        public TotalsMessage() : base(Profile.GetMessage(MessageNum.Totals))
        {
        }

        public TotalsMessage(Message mesg) : base(mesg)
        {
        }
