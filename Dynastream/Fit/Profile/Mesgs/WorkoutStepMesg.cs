...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class WorkoutStepMessage : Message
    {
        #region Fields
        ...
        /// <summary>
        /// Field Numbers for <see cref="WorkoutStepMessage"/>
        /// </summary>
        ...
        #region Constructors
        public WorkoutStepMessage() : base(Profile.GetMessage(MessageNum.WorkoutStep))
        {
        }

        public WorkoutStepMessage(Message mesg) : base(mesg)
        {
        }
