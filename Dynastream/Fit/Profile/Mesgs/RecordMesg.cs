...
#endregion
// C:\FIT Dev\cs\Dynastream\Fit\Profile\Messages\RecordMessage.cs
using System;
...
{
    /// <summary>
    /// Implements the Object profile message.
    /// </summary>
    public class Record : Message
    {
        ...
        /// <summary>
        /// Field Numbers for <see cref="Record"/>
        /// </summary>
        ...
        #region Constructors
        public Record() : base(Profile.GetMessage(MessageNum.Record))
        {
        }

        public Record(Message mesg) : base(mesg)
        {
        }
