...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class PowerZoneMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="PowerZoneMessage"/>
        /// </summary>
        ...
        #region Constructors
        public PowerZoneMessage() : base(Profile.GetMessage(MessageNum.PowerZone))
        {
        }

        public PowerZoneMessage(Message mesg) : base(mesg)
        {
        }
