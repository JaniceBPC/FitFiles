...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class SpeedZoneMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="SpeedZoneMessage"/>
        /// </summary>
        ...
        #region Constructors
        public SpeedZoneMessage() : base(Profile.GetMessage(MessageNum.SpeedZone))
        {
        }

        public SpeedZoneMessage(Message mesg) : base(mesg)
        {
        }
