...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class WorkoutMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="WorkoutMessage"/>
        /// </summary>
        ...
        #region Constructors
        public WorkoutMessage() : base(Profile.GetMessage(MessageNum.Workout))
        {
        }

        public WorkoutMessage(Message mesg) : base(mesg)
        {
        }
