...
namespace Dynastream.Fit
{
    ...
    public class CapabilitiesMessage : Message
    {
        ...
        /// <summary>
        /// Field Numbers for <see cref="CapabilitiesMessage"/>
        /// </summary>
        ...
        #region Constructors
        public CapabilitiesMessage() : base(Profile.GetMessage(MessageNum.Capabilities))
        {
        }

        public CapabilitiesMessage(Message mesg) : base(mesg)
        {
        }
