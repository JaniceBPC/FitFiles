...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class FileCapabilitiesMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="FileCapabilitiesMessage"/>
        /// </summary>
        ...
        #region Constructors
        public FileCapabilitiesMessage() : base(Profile.GetMessage(MessageNum.FileCapabilities))
        {
        }

        public FileCapabilitiesMessage(Message mesg) : base(mesg)
        {
        }
