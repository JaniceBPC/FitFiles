...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class ExdScreenConfigurationMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="ExdScreenConfigurationMessage"/>
        /// </summary>
        ...
        #region Constructors
        public ExdScreenConfigurationMessage() : base(Profile.GetMessage(MessageNum.ExdScreenConfiguration))
        {
        }

        public ExdScreenConfigurationMessage(Message mesg) : base(mesg)
        {
        }
