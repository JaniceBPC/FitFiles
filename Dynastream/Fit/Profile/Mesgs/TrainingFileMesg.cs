...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class TrainingFileMessage : Message
    {
        #region Fields
        ...
        /// <summary>
        /// Field Numbers for <see cref="TrainingFileMessage"/>
        /// </summary>
        ...
        #region Constructors
        public TrainingFileMessage() : base(Profile.GetMessage(MessageNum.TrainingFile))
        {
        }

        public TrainingFileMessage(Message mesg) : base(mesg)
        {
        }
