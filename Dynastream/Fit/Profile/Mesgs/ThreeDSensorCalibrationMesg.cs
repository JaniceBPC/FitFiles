...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class ThreeDSensorCalibrationMessage : Message
    {
        #region Fields
        ...
        /// <summary>
        /// Field Numbers for <see cref="ThreeDSensorCalibrationMessage"/>
        /// </summary>
        ...
        #region Constructors
        public ThreeDSensorCalibrationMessage() : base(Profile.GetMessage(MessageNum.ThreeDSensorCalibration))
        {
        }

        public ThreeDSensorCalibrationMessage(Message mesg) : base(mesg)
        {
        }
