...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class MemoGlobMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="MemoGlobMessage"/>
        /// </summary>
        ...
        #region Constructors
        public MemoGlobMessage() : base(Profile.GetMessage(MessageNum.MemoGlob))
        {
        }

        public MemoGlobMessage(Message mesg) : base(mesg)
        {
        }
