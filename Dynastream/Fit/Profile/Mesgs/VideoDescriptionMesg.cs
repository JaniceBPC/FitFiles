...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class VideoDescriptionMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="VideoDescriptionMessage"/>
        /// </summary>
        ...
        #region Constructors
        public VideoDescriptionMessage() : base(Profile.GetMessage(MessageNum.VideoDescription))
        {
        }

        public VideoDescriptionMessage(Message mesg) : base(mesg)
        {
        }
