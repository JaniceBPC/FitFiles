...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class WorkoutSessionMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="WorkoutSessionMessage"/>
        /// </summary>
        ...
        #region Constructors
        public WorkoutSessionMessage() : base(Profile.GetMessage(MessageNum.WorkoutSession))
        {
        }

        public WorkoutSessionMessage(Message mesg) : base(mesg)
        {
        }
