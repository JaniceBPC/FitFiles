...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class WeatherAlertMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="WeatherAlertMessage"/>
        /// </summary>
        ...
        #region Constructors
        public WeatherAlertMessage() : base(Profile.GetMessage(MessageNum.WeatherAlert))
        {
        }

        public WeatherAlertMessage(Message mesg) : base(mesg)
        {
        }
