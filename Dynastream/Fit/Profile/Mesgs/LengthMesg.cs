...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class LengthMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="LengthMessage"/>
        /// </summary>
        ...
        #region Constructors
        public LengthMessage() : base(Profile.GetMessage(MessageNum.Length))
        {
        }

        public LengthMessage(Message mesg) : base(mesg)
        {
        }
