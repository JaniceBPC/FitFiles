...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class BikeProfileMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="BikeProfileMessage"/>
        /// </summary>
        ...
        #region Constructors
        public BikeProfileMessage() : base(Profile.GetMessage(MessageNum.BikeProfile))
        {
        }

        public BikeProfileMessage(Message mesg) : base(mesg)
        {
        }
