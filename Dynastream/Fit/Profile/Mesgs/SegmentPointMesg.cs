...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class SegmentPointMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="SegmentPointMessage"/>
        /// </summary>
        ...
        #region Constructors
        public SegmentPointMessage() : base(Profile.GetMessage(MessageNum.SegmentPoint))
        {
        }

        public SegmentPointMessage(Message mesg) : base(mesg)
        {
        }
