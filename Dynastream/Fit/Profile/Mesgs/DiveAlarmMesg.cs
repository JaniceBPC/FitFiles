...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class DiveAlarmMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="DiveAlarmMessage"/>
        /// </summary>
        ...
        #region Constructors
        public DiveAlarmMessage() : base(Profile.GetMessage(MessageNum.DiveAlarm))
        {
        }

        public DiveAlarmMessage(Message mesg) : base(mesg)
        {
        }
