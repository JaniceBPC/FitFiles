...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class ConnectivityMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="ConnectivityMessage"/>
        /// </summary>
        ...
        #region Constructors
        public ConnectivityMessage() : base(Profile.GetMessage(MessageNum.Connectivity))
        {
        }

        public ConnectivityMessage(Message mesg) : base(mesg)
        {
        }
