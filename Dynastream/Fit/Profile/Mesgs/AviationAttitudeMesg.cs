...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class AviationAttitudeMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="AviationAttitudeMessage"/>
        /// </summary>
        ...
        #region Constructors
        public AviationAttitudeMessage() : base(Profile.GetMessage(MessageNum.AviationAttitude))
        {
        }

        public AviationAttitudeMessage(Message mesg) : base(mesg)
        {
        }
