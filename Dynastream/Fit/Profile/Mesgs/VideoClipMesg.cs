...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class VideoClipMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="VideoClipMessage"/>
        /// </summary>
        ...
        #region Constructors
        public VideoClipMessage() : base(Profile.GetMessage(MessageNum.VideoClip))
        {
        }

        public VideoClipMessage(Message mesg) : base(mesg)
        {
        }
