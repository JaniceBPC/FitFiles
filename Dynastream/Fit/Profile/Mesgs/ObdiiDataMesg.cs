...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class ObdiiDataMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="ObdiiDataMessage"/>
        /// </summary>
        ...
        #region Constructors
        public ObdiiDataMessage() : base(Profile.GetMessage(MessageNum.ObdiiData))
        {
        }

        public ObdiiDataMessage(Message mesg) : base(mesg)
        {
        }
