...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class DiveSummaryMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="DiveSummaryMessage"/>
        /// </summary>
        public sealed class FieldDefNum
        {
            public const byte Timestamp = 253;
            public const byte ReferenceMessage = 0;
        ...
        #region Constructors
        public DiveSummaryMessage() : base(Profile.GetMessage(MessageNum.DiveSummary))
        {
        }

        public DiveSummaryMessage(Message mesg) : base(mesg)
        {
        }
        ...
        ///<summary>
        /// Retrieves the ReferenceMessage field</summary>
        /// <returns>Returns nullable ushort representing the ReferenceMessage field</returns>
        public ushort? GetReferenceMessage()
        {
        ...
        /// <summary>
        /// Set ReferenceMessage field</summary>
        /// <param name="referenceMessage_">Nullable field value to be set</param>
        public void SetReferenceMessage(ushort? referenceMessage_)
        {
            SetFieldValue(0, 0, referenceMessage_, Fit.SubfieldIndexMainField);
        }
