...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class GpsMetadataMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="GpsMetadataMessage"/>
        /// </summary>
        ...
        #region Constructors
        public GpsMetadataMessage() : base(Profile.GetMessage(MessageNum.GpsMetadata))
        {
        }

        public GpsMetadataMessage(Message mesg) : base(mesg)
        {
        }
