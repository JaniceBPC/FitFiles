...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class WeatherConditionsMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="WeatherConditionsMessage"/>
        /// </summary>
        ...
        #region Constructors
        public WeatherConditionsMessage() : base(Profile.GetMessage(MessageNum.WeatherConditions))
        {
        }

        public WeatherConditionsMessage(Message mesg) : base(mesg)
        {
        }
