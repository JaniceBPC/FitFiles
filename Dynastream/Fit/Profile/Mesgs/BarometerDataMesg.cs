...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class BarometerDataMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="BarometerDataMessage"/>
        /// </summary>
        ...
        #region Constructors
        public BarometerDataMessage() : base(Profile.GetMessage(MessageNum.BarometerData))
        {
        }

        public BarometerDataMessage(Message mesg) : base(mesg)
        {
        }
