...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class MetZoneMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="MetZoneMessage"/>
        /// </summary>
        ...
        #region Constructors
        public MetZoneMessage() : base(Profile.GetMessage(MessageNum.MetZone))
        {
        }

        public MetZoneMessage(Message mesg) : base(mesg)
        {
        }
