...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class OhrSettingsMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="OhrSettingsMessage"/>
        /// </summary>
        ...
        #region Constructors
        public OhrSettingsMessage() : base(Profile.GetMessage(MessageNum.OhrSettings))
        {
        }

        public OhrSettingsMessage(Message mesg) : base(mesg)
        {
        }
