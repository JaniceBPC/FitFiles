...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class GyroscopeDataMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="GyroscopeDataMessage"/>
        /// </summary>
        ...
        #region Constructors
        public GyroscopeDataMessage() : base(Profile.GetMessage(MessageNum.GyroscopeData))
        {
        }

        public GyroscopeDataMessage(Message mesg) : base(mesg)
        {
        }
