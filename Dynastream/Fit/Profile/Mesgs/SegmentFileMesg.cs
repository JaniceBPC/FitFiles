...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class SegmentFileMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="SegmentFileMessage"/>
        /// </summary>
        ...
        #region Constructors
        public SegmentFileMessage() : base(Profile.GetMessage(MessageNum.SegmentFile))
        {
        }

        public SegmentFileMessage(Message mesg) : base(mesg)
        {
        }
