...
namespace Dynastream.Fit
{
    ...
    public class ActivityMessage : Message
    {
        ...
        /// <summary>
        /// Field Numbers for <see cref="ActivityMessage"/>
        /// </summary>
        ...
        #region Constructors
        public ActivityMessage() : base(Profile.GetMessage(MessageNum.Activity))
        {
        }

        public ActivityMessage(Message mesg) : base(mesg)
        {
        }
