...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class BloodPressureMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="BloodPressureMessage"/>
        /// </summary>
        ...
        #region Constructors
        public BloodPressureMessage() : base(Profile.GetMessage(MessageNum.BloodPressure))
        {
        }

        public BloodPressureMessage(Message mesg) : base(mesg)
        {
        }
