...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class AntTxMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="AntTxMessage"/>
        /// </summary>
        ...
        #region Constructors
        public AntTxMessage() : base(Profile.GetMessage(MessageNum.AntTx))
        {
        }

        public AntTxMessage(Message mesg) : base(mesg)
        {
        }
