...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class AccelerometerDataMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="AccelerometerDataMessage"/>
        /// </summary>
        ...
        #region Constructors
        public AccelerometerDataMessage() : base(Profile.GetMessage(MessageNum.AccelerometerData))
        {
        }

        public AccelerometerDataMessage(Message mesg) : base(mesg)
        {
        }
