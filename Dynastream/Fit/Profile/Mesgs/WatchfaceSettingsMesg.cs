...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class WatchfaceSettingsMessage : Message
    {
        #region Fields
        ...
        /// <summary>
        /// Field Numbers for <see cref="WatchfaceSettingsMessage"/>
        /// </summary>
        ...
        #region Constructors
        public WatchfaceSettingsMessage() : base(Profile.GetMessage(MessageNum.WatchfaceSettings))
        {
        }

        public WatchfaceSettingsMessage(Message mesg) : base(mesg)
        {
        }
