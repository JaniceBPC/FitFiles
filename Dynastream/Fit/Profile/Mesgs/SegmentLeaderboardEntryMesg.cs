...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class SegmentLeaderboardEntryMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="SegmentLeaderboardEntryMessage"/>
        /// </summary>
        ...
        #region Constructors
        public SegmentLeaderboardEntryMessage() : base(Profile.GetMessage(MessageNum.SegmentLeaderboardEntry))
        {
        }

        public SegmentLeaderboardEntryMessage(Message mesg) : base(mesg)
        {
        }
