...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class FieldDescriptionMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="FieldDescriptionMessage"/>
        /// </summary>
        public sealed class FieldDefNum
        {
            ...
            public const byte NativeMessageNum = 14;
            public const byte NativeFieldNum = 15;
            public const byte Invalid = Fit.FieldNumInvalid;
        }

        #region Constructors
        public FieldDescriptionMessage() : base(Profile.GetMessage(MessageNum.FieldDescription))
        {
        }

        public FieldDescriptionMessage(Message mesg) : base(mesg)
        {
        }
        ...
        ///<summary>
        /// Retrieves the NativeMessageNum field</summary>
        /// <returns>Returns nullable ushort representing the NativeMessageNum field</returns>
        public ushort? GetNativeMessageNum()
        {
        ...
        /// <summary>
        /// Set NativeMessageNum field</summary>
        /// <param name="nativeMessageNum_">Nullable field value to be set</param>
        public void SetNativeMessageNum(ushort? nativeMessageNum_)
        {
            SetFieldValue(14, 0, nativeMessageNum_, Fit.SubfieldIndexMainField);
        }
