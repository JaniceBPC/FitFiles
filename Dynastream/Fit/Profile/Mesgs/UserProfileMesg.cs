...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class UserProfileMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="UserProfileMessage"/>
        /// </summary>
        ...
        #region Constructors
        public UserProfileMessage() : base(Profile.GetMessage(MessageNum.UserProfile))
        {
        }

        public UserProfileMessage(Message mesg) : base(mesg)
        {
        }
