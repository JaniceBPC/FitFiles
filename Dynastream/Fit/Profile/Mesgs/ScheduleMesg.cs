...
namespace Dynastream.Fit
{
    ...
    public class ScheduleMessage : Message
    {
        ...
        /// <summary>
        /// Field Numbers for <see cref="ScheduleMessage"/>
        /// </summary>
        ...
        #region Constructors
        public ScheduleMessage() : base(Profile.GetMessage(MessageNum.Schedule))
        {
        }

        public ScheduleMessage(Message mesg) : base(mesg)
        {
        }
