...
namespace Dynastream.Fit
{
    ...
    /// </summary>
    public class HrmProfileMessage : Message
    {
        #region Fields
        #endregion

        /// <summary>
        /// Field Numbers for <see cref="HrmProfileMessage"/>
        /// </summary>
        ...
        #region Constructors
        public HrmProfileMessage() : base(Profile.GetMessage(MessageNum.HrmProfile))
        {
        }

        public HrmProfileMessage(Message mesg) : base(mesg)
        {
        }
